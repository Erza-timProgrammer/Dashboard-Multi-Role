...
$(".form_edt_mhs").on("submit", function (e) {
    ...
    if (
        currentData.tempat_lahir_mahasiswa !==
        initialData.tempat_lahir_mahasiswa
    ) {
        changedData.tempat_lahir_mahasiswa = currentData.tempat_lahir_mahasiswa;
    }

    if (
        currentData.tanggal_lahir_mahasiswa !==
        initialData.tanggal_lahir_mahasiswa
    ) {
        changedData.tanggal_lahir_mahasiswa =
            currentData.tanggal_lahir_mahasiswa;
    }
