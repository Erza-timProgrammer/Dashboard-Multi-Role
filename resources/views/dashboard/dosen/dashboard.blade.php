                ...
                <div class="w-full">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-1.5">
                        <form action="{{ route('accept_req',$item->id) }}" method="POST" class="inline">
                            @csrf
                            <button type="submit" class="button-blue w-full p-2">Accept</button>
                        </form>
...
@section('content')
    ...
    @else
        <div class="w-full flex justify-between items-center mb-3">
            ...
            <div class="ml-3 flex gap-2">
                <button data-modal-target="addnewmahasiswaclass" data-modal-toggle="addnewmahasiswaclass"
                    class="bg-blue-500 py-3 px-4 text-white text-sm  shadow rounded-md">+ Masukan Mahasiswa Baru</button>
                <!-- Main modal -->
        ...
        <table class="w-full text-left table-auto min-w-max bg-white rounded-lg overflow-hidden">
            <thead>
                <tr>
                    <th class="p-4 ps-6 border-b border-slate-100 bg-blue-500">
                        <p class="text-sm font-medium leading-none text-gray-200 ">
                            No
                        </p>
                    </th>
                    <th class="p-4 border-b border-slate-100 bg-blue-500">
                        <p class="text-sm font-medium leading-none text-gray-200">
                            Nama
                        </p>
                    </th>
                    ...
                    <th class="p-4 border-b border-slate-100 bg-blue-500 pe-6 w-44">
                        <p class="text-sm font-medium leading-none text-gray-200">
                            Action
                        </p>
                    </th>
