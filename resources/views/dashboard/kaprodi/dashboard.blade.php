...
<div>
<h1 class="flex items-center mt-4 mb-6 text-5xl font-extrabold dark:text-white">Coming<span class="bg-blue-100 text-blue-800 text-2xl font-semibold me-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-2">Soon</span></h1>
</div>
...
<div id="alert-additional-content-1" class="p-4 mb-4 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
    ...
    <div class="mt-2 mb-4 text-sm">
        "Welcome to our new academic system! We're currently in the development phase, building a platform that will streamline academic processes and improve the learning experience. Stay tuned for the official launch, where you'll be able to explore features such as course management, grade tracking and online assessments"
    </div>
    <div class="flex">
